            ...
            <form className='flex flex-wrap w-full items-start justify-between'>
                <div className='w-1/2'>
                    ...
                    <div>
                        ...
                        <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4 ' type='Date' placeholder='dd/mm/yyyy'></input>
                    </div>
                    <div>
                        <h3 className='text-sm text-gray-300 mb-0.5'>Assign To</h3>
                        <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4 ' type='text' placeholder='Employee Name'></input>
                    </div>
                    <div>
                ...
                <div className='w-2/5 flex flex-col items-start'>
                    ...
                    <button className='bg-emerald-500  py-3 hover:bg-emerald-600 px-5 rounded text-xl mt-4 w-full '>Create Task</button>
                </div>
            </form>
